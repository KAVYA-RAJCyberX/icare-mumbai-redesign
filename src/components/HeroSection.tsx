...
export const HeroSection = () => {
  ...
  return <section id="home" className="relative min-h-screen bg-hero-gradient overflow-hidden pt-32">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-8rem)]">
          ...
          duration: 0.8
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button variant="hero-outline" size="xl" onClick={() => document.querySelector("#services")?.scrollIntoView({
              behavior: "smooth"
            })}>
                Our Services
              </Button>
